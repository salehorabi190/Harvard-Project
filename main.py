...
menu = {
    ...
    "28. هندسة المالية المقاصدية (P)": "m28", "29. تسعير المنتجات المصرفية (P_b)": "m29", "30. خوارزمية التقييم الشرعي التنبؤية (M_impact)": "m30", "31. مؤشر الأمان الشرعي (SSI)": "m31", "32. بروتوكول الإشراف وتصنيف الأصول (SCS)": "m32"
}
